...
var cobolscript = (function() {
    ...
    var reserved = ["to", "from", "by", "into", "division", "section", "end-if", "end-perform", "end-read"];
    ...
    function Parser(text) {
        ...
        function parseExpressions(program) {
            var list = [];
            list.push(parseExpression(program));
